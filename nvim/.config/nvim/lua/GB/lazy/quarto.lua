return {
...

  {
    ...
    priority = 1000,
    opts = {
      backend = "kitty",                -- change to "wezterm" if you use wezterm
      integrations = {
        markdown = { enabled = false }, -- you only need it for Molten, not markdown
      },
      max_width = 120,
      max_height = 40,
  ...
  { -- molten nvim
    ...
    init = function()
      ...
      vim.g.molten_virt_text_max_lines = 12      -- or more
      vim.g.molten_virt_text_truncate = "bottom" -- when too tall
      vim.g.molten_wrap_output = true

      -- (recommended for markdown/quarto fences: makes placement nicer)
      vim.g.molten_virt_lines_off_by_1 = true
      vim.g.molten_cover_empty_lines = true

      -- optional: keep images inline as virt output too
